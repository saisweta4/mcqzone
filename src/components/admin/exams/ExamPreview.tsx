        ...
        <div className="bg-white rounded-lg border shadow-sm overflow-hidden flex flex-col">
          ...
          <div className="p-5 flex-1">
            ...
            <div className="space-y-3 pt-4 border-t">
              <Link href={`/admin/exams/${exam.slug}`} className="w-full flex justify-center py-2.5 bg-primary hover:bg-blue-700 text-white text-sm font-medium rounded-md transition-colors">
                View Full Details
              </Link>
